...
INSERT INTO distance_thresholds (city, category, bracket, max_km) VALUES
  ...
  ('Lima', 'Comfort+/Premier', 'very_short',  2.09),
  ('Lima', 'Comfort+/Premier', 'short',        4.36),
  ('Lima', 'Comfort+/Premier', 'median',       7.00),
  ('Lima', 'Comfort+/Premier', 'average',     10.98),
  ('Lima', 'Comfort+/Premier', 'long',        15.00),
  ('Lima', 'Comfort+/Premier', 'very_long',   NULL),
...
-- AREQUIPA
  ...
  ('Arequipa', 'Comfort/Comfort+', 'very_short',  1.94),
  ('Arequipa', 'Comfort/Comfort+', 'short',        3.19),
  ('Arequipa', 'Comfort/Comfort+', 'median',       4.11),
  ('Arequipa', 'Comfort/Comfort+', 'average',      5.60),
  ('Arequipa', 'Comfort/Comfort+', 'long',          8.76),
  ('Arequipa', 'Comfort/Comfort+', 'very_long',    NULL),
...
-- TRUJILLO
  ...
  ('Trujillo', 'Comfort/Comfort+', 'very_short',  1.10),
  ('Trujillo', 'Comfort/Comfort+', 'short',        1.81),
  ('Trujillo', 'Comfort/Comfort+', 'median',       2.68),
  ('Trujillo', 'Comfort/Comfort+', 'average',      4.06),
  ('Trujillo', 'Comfort/Comfort+', 'long',          7.66),
  ('Trujillo', 'Comfort/Comfort+', 'very_long',    NULL),
