...
export const RAW_DATA_COLUMNS =
  'id, country, city, year, week, observed_date, observed_time, rush_hour, surge, category, competition_name, data_source, distance_bracket, zone, distance_km, point_a, point_b, price_without_discount, price_with_discount, recommended_price, minimal_bid, bid_1, bid_2, bid_3, bid_4, bid_5, eta_min, uploaded_by'
