...
// COMPETITOR_COLORS vive en su propio módulo (ver competitorColors.js) para
// evitar un import circular con catalogs.js, que también la necesita.
// Re-exportada acá para no romper los ~20 componentes que la importan de
// constants.js.
export {
  COMPETITOR_COLORS,
  LEGACY_SPACE_FORM_COMPETITORS,
  CANONICAL_COMPETITOR_NAMES,
} from './competitorColors.js'
