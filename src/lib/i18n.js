...
export const TRANSLATIONS = {
  es: {
    // ── Global ─────────────────────────────────────────
    'earnings.params': 'Parámetros',
    'earnings.col_competitor': 'Competidor',
    'earnings.col_avg_price_trip': 'Precio prom. / viaje',
    'earnings.col_observations': '# Observaciones',
    'earnings.col_commission_pct': 'Comisión %',
    'earnings.includes_bonus': 'Incluye bono',
    'earnings.price_per_trip': 'Precio/viaje',
    'earnings.bonus': 'Bono',
    'earnings.net_total': 'Total neto',
    'earnings.notes_placeholder': 'Notas del escenario (opcional)…',
    'earnings.col_date': 'Fecha',
    'earnings.col_ref_week': 'Semana ref.',
    'earnings.col_scale': 'Escala',
    'earnings.col_notes': 'Notas',
    'earnings.col_user': 'Usuario',
    'report.card_competitors': 'Competidores',
    'report.card_active_brackets': 'Brackets activos',
    'report.card_ref_week': 'Semana ref.',
    'report.card_comparison': 'Comparación',
    'report.year': 'Año {year}',
    'report.col_bracket': 'Bracket',
  ...
  en: {
    'earnings.params': 'Parameters',
    'earnings.col_competitor': 'Competitor',
    'earnings.col_avg_price_trip': 'Avg price / trip',
    'earnings.col_observations': '# Observations',
    'earnings.col_commission_pct': 'Commission %',
    'earnings.includes_bonus': 'Includes bonus',
    'earnings.price_per_trip': 'Price/trip',
    'earnings.bonus': 'Bonus',
    'earnings.net_total': 'Net total',
    'earnings.notes_placeholder': 'Scenario notes (optional)…',
    'earnings.col_date': 'Date',
    'earnings.col_ref_week': 'Ref. week',
    'earnings.col_scale': 'Scale',
    'earnings.col_notes': 'Notes',
    'earnings.col_user': 'User',
    'report.card_competitors': 'Competitors',
    'report.card_active_brackets': 'Active brackets',
    'report.card_ref_week': 'Ref. week',
    'report.card_comparison': 'Comparison',
    'report.year': 'Year {year}',
    'report.col_bracket': 'Bracket',
  ...
  ru: {
    'earnings.params': 'Параметры',
    'earnings.col_competitor': 'Конкурент',
    'earnings.col_avg_price_trip': 'Средняя цена / поездка',
    'earnings.col_observations': '№ наблюдений',
    'earnings.col_commission_pct': 'Комиссия %',
    'earnings.includes_bonus': 'Включает бонус',
    'earnings.price_per_trip': 'Цена/поездка',
    'earnings.bonus': 'Бонус',
    'earnings.net_total': 'Итого чистыми',
    'earnings.notes_placeholder': 'Заметки к сценарию (необязательно)…',
    'earnings.col_date': 'Дата',
    'earnings.col_ref_week': 'Опорная неделя',
    'earnings.col_scale': 'Масштаб',
    'earnings.col_notes': 'Заметки',
    'earnings.col_user': 'Пользователь',
    'report.card_competitors': 'Конкуренты',
    'report.card_active_brackets': 'Активные брекеты',
    'report.card_ref_week': 'Опорная неделя',
    'report.card_comparison': 'Сравнение',
    'report.year': '{year} год',
    'report.col_bracket': 'Брекет',
