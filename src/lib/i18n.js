...
export const TRANSLATIONS = {
  es: {
    ...
    'projects.cities_hint':
      'Si no marcás ninguna, el proyecto aplica a todas las ciudades del país.',
    ...
    'rentabilidad.toggle_detail_tooltip':
      'Mostrar/ocultar columnas Comisión efectiva y % por bonos',
  ...
  en: {
    ...
    'projects.shift_preview':
      '{n} with dates: {desde} → {hasta} becomes {nuevoDesde} → {nuevoHasta}',
  ...
  ru: {
    ...
    'projects.summary_counts':
      '{today} на сегодня · {overdue} просрочено · {blocked} заблокировано',
    ...
    'config.bonuses_config.new_version_invalid_from':
      'Дата должна быть позже начала текущей версии.',
