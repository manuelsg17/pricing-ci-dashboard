...
export default {
  ...
  'competitor.short.YangoCargoPickup': 'Пикап',
  'competitor.short.YangoCargoM': 'Средний',
  'competitor.short.YangoCargoXL': 'Большой',
  'competitor.short.InDriveCargoPickup': 'Пикап/Внедорожник',
  'competitor.short.InDriveCargoVan': 'Фургон',
  'competitor.short.InDriveCargoLiviano': 'Лёгкий',
  'competitor.short.InDriveCargoGrande': 'Грузовик',
  'competitor.full.YangoCargoXP': 'Очень маленький грузовик',
  'competitor.full.YangoCargoPickup': 'Минивэн/Пикап',
  'competitor.full.YangoCargoM': 'Средний грузовик',
  'competitor.full.YangoCargoXL': 'Большой грузовик',
  'competitor.full.InDriveCargoPickup': 'Пикап и внедорожник',
  'competitor.full.InDriveCargoVan': 'Фургон',
  'competitor.full.InDriveCargoLiviano': 'Лёгкий грузовик',
  'competitor.full.InDriveCargoGrande': 'Грузовик',
  ...
  'dataentry.common_origin': 'Начало всех маршрутов:',
  'dataentry.common_origin_hint': '(в карточке показан только пункт назначения)',
  'dataentry.route_n_of': 'Маршрут {i}/{n}',
  'dataentry.route_done': 'Маршрут заполнен',
  'dataentry.route_partial': 'Маршрут заполнен частично',
  'dataentry.route_empty': 'Маршрут не начат',
  'dataentry.band_routes': 'маршрутов',
  'dataentry.minimap_label': 'Прогресс по диапазонам',
  ...
  'dataentry.lease_readonly_take': 'Использовать эту вкладку',
  'dataentry.ts_jump_title': 'Перейти к таймслоту {ts}',
  'dataentry.grid_summary': '{r} маршрутов · {n} таймслота',
  'dataentry.legend_more': 'Показать ещё (InDrive, сохранение и завершение)',
  'dataentry.legend_less': 'Свернуть',
  'dataentry.lease_readonly_title': 'Эта вкладка только для чтения.',
  'dataentry.lease_readonly_body':
    'У вас открыта другая вкладка с этим же вводом. Продолжайте там или, если уже закрыли её, возьмите управление здесь.',
  ...
  'dataentry.legend_step1':
    'Вверху выберите город и вкладку: Обычный, Corp, ✈ Аэропорт, TukTuk, Delivery или Cargo. Для Аэропорта ДО нажатия «Начать сессию» выберите Точку А, Точку Б или Обе (при «Обе» таймер не прерывается при переключении). Для TukTuk выберите район: каждый район сохраняется и завершается отдельно. Затем выберите дату.',
  'dataentry.legend_step2':
    'Таблица идёт по таймслотам (Утро → День → Вечер), а внутри таймслота — по брекетам расстояния; у каждого брекета свой цвет и диапазон км. Заголовок таймслота закреплён при прокрутке: цветные чипы показывают, сколько маршрутов готово в каждом брекете, а нажатие на чип переводит сразу к этому блоку.',
  'dataentry.legend_step3':
    'Каждая карточка — маршрут («Маршрут 3/12») со статусом: ○ пусто, ● частично, ✓ готово. Укажите цену каждого конкурента (и ETA в минутах там, где оно есть; Delivery и Cargo его не требуют). Если предложения не было, используйте кнопку «Н/Д» в строке. Заполните весь маршрут, прежде чем переходить к следующему.',
  'dataentry.legend_step4':
    'Для InDrive (и его вариантов Cargo) нажмите ▼, чтобы записать РЕКОМЕНДОВАННУЮ цену и до 5 ставок. Среднее считается только по ставкам; если их нет, берётся рекомендованная. Напр.: Рекомендовано=14, Ставка 1=15, Ставка 2=13, Ставка 3=17 → среднее 15.00. Нажмите «?» на панели, чтобы увидеть пример.',
  'dataentry.legend_step5':
    'Сохраняйте почаще кнопкой «💾 Сохранить прогресс» (неполные строки тоже сохраняются). Прогресс также автосохраняется в этом браузере: он не теряется при обновлении страницы, смене города или случайном закрытии.',
  'dataentry.legend_step6':
    '«⏹ Завершить сессию» требует полностью заполненной таблицы (все 3 таймслота). В Аэропорту с охватом «Обе» после первой Точки кнопка покажет «Завершить эту точку»: сессия остаётся активной, и вы переходите к другой; по-настоящему она закончится после второй.',
  'dataentry.tab_normal': 'Обычный',
  'dataentry.tab_airport': 'Аэропорт',
  'dataentry.tab_delivery': 'Доставка',
  'dataentry.tab_cargo': 'Грузоперевозки',
