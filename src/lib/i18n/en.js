...
export default {
  ...
  'competitor.short.YangoCargoM': 'Medium',
  'competitor.short.YangoCargoXL': 'Large',
  'competitor.short.InDriveCargoPickup': 'Pickup/SUV',
  'competitor.short.InDriveCargoVan': 'Van',
  'competitor.short.InDriveCargoLiviano': 'Light',
  'competitor.short.InDriveCargoGrande': 'Truck',
  'competitor.full.YangoCargoXP': 'Extra Small Truck',
  'competitor.full.YangoCargoPickup': 'Minivan/Pickup',
  'competitor.full.YangoCargoM': 'Medium Truck',
  'competitor.full.YangoCargoXL': 'Large Truck',
  'competitor.full.InDriveCargoPickup': 'Pickup and SUV',
  'competitor.full.InDriveCargoVan': 'Van',
  'competitor.full.InDriveCargoLiviano': 'Light Truck',
  'competitor.full.InDriveCargoGrande': 'Truck',
  ...
  'competitividad.week_range.shared': 'Follow the dashboard filter',
  'routemon.shared_range_hint': 'Global filter period: {from} → {to}',
  'routemon.shared_range_note':
    'Follows the period chosen in the Dashboard (max 31 days: the last ones are used). Edit the dates to pin another.',
  'routemon.use_shared_range': '↺ Use global filter',
