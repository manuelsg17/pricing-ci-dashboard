      ...
      <div className="config-section">
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 16 }}>
          ...
          <button
            ...
            title="Lee 3 filas de la tabla foránea — confirma que postgres_fdw está bien configurado"
          >
            {probing ? 'Sondeando…' : '🔍 Probar conexión FDW'}
          </button>
          <label style={{ fontSize: 11, display: 'flex', alignItems: 'center', gap: 6, marginLeft: 8 }}>
            Límite por corrida
            <input
